...
final class SearchAdaptor extends BaseAdapter {
    private final Context context;
    private final List<String> urls = new ArrayList<String>();

    public SearchAdaptor(Context context, List<Stream> streams) {
        ...
        for (Stream stream : streams) {
            if (stream.coverImageUrl != null && !stream.coverImageUrl.equals(""))
                ...
                urls.add("http://placehold.it/1024x1024/ss&text="+stream.name);
        }
